...
namespace CarRentalInfrastructure.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(CarRentalDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            return RedirectToAction("Index", "Cars", new { controller = "Cars", action = "Index", categoryId = category.Id, categoryName = category.Name });
        }
